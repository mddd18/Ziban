...
export default function ProfileScreen({ user, onBack, onLogout }: ProfileScreenProps) {
  return (
    <div className="min-h-screen bg-[#F5EEDC] font-sans pb-10">
      {/* HEADER: Turquoise fon va silliq chekkalar */}
      <div className="bg-[#2EB8A6] p-6 rounded-b-[40px] shadow-lg relative">
        <button onClick={onBack} className="absolute top-8 left-6 p-2 bg-white/20 rounded-xl backdrop-blur-md border border-white/30 text-white active:scale-90 transition-all">
      ...
      {/* STATISTIKA: Baza ma'lumotlari bilan (Streak va Progress) */}
